      ...
      <div className="container sm:px-32 py-24 mx-auto">
        <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
          ...
          <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">
            Connect your first account in less than 1 minute
          </p>
        </div>
        <div className="flex flex-wrap -m-4">
          ...
          <div className="xl:w-1/3 md:w-1/2 p-4">
            <div className="border border-slate-200 p-6 rounded-lg">
              ...
              <p className="leading-relaxed text-base">
              We keep safe your web3 earnings so you do not need to care about passwords, losing your private keys, scams, etc.
              </p>
            </div>
          </div>
          <div className="xl:w-1/3 md:w-1/2 p-4">
            <div className="border border-slate-200 p-6 rounded-lg">
              ...
              <p className="leading-relaxed text-base">
              Optionally, we convert your web3 earnings to fiat money and send it to your bank account.
              </p>
            </div>
          </div>
          <div className="xl:w-1/3 md:w-1/2 p-4">
